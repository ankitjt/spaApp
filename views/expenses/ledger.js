export const Ledger = () =>
{
  const html = /* html */`
    ...
    <span class="currentDate rounded-lg bg-black text-white w-fit inline-block p-3 text-xs">2025-30-05</span>
    </div>
  ...
  const init = () =>
  {
    ...
    db.collection( "expenseDetails" ).onSnapshot( querySnapshot =>
    {
